...
const Intro = (props) => {
    return (
        ...
        >
            ...
            <br></br>
            <p >In this study we are interested in how people describe what they think will happen in a given situation.</p>
            <br></br>
            <p>
                You will see a series of boxes. Each box contains a combination of balls of different colors. We will ask you to imagine what will happen if someone randomly draws a ball from a box.
            </p>

            <br></br>
            <p>Specifically, we will ask you to make a guess about the color of the ball that will come out.</p>
